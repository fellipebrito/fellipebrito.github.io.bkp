...
return cljs.core.map.call(null,cljs.core.first,cljs.core.filter.call(null,(function (p1__36141_SHARP_){
return cljs.core._EQ_.call(null,cljs.core.second.call(null,p1__36141_SHARP_),matcher);
...
}), "className": "restart animated infinite pulse"},"Play Again!")):null),((ttt.core.draw_QMARK_.call(null,new cljs.core.Keyword(null,"board","board",-1907017633).cljs$core$IFn$_invoke$arity$1(data)))?React.DOM.div({"className": "alert"},React.DOM.div({"className": "finalMessage animated tada"},[cljs.core.str(cljs.core.rand_nth.call(null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, ["Win or Win. There is no Draw","I will kick your but in the next","Boooooring"], null)))].join('')),React.DOM.button({"onClick": (function (){
return om.core.set_state_BANG_.call(null,owner,new cljs.core.Keyword(null,"board","board",-1907017633),ttt.core.restart.call(null,data));
...
if(typeof ttt.core.t36151 !== 'undefined'){
} else {

/**
* @constructor
*/
ttt.core.t36151 = (function (owner,data,game,meta36152){
this.owner = owner;
this.data = data;
this.game = game;
...
ttt.core.t36151.prototype.om$core$IRenderState$ = true;

ttt.core.t36151.prototype.om$core$IRenderState$render_state$arity$2 = (function (_,p__36154){
var self__ = this;
var map__36155 = p__36154;
var map__36155__$1 = ((cljs.core.seq_QMARK_.call(null,map__36155))?cljs.core.apply.call(null,cljs.core.hash_map,map__36155):map__36155);
var ___$1 = this;
return ttt.core.show_board.call(null,self__.owner,self__.data);
});

ttt.core.t36151.prototype.om$core$IInitState$ = true;

ttt.core.t36151.prototype.om$core$IInitState$init_state$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
return cljs.core.PersistentArrayMap.EMPTY;
});

ttt.core.t36151.prototype.om$core$ICheckState$ = true;

ttt.core.t36151.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_36153){
var self__ = this;
var _36153__$1 = this;
return self__.meta36152;
});

ttt.core.t36151.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_36153,meta36152__$1){
var self__ = this;
var _36153__$1 = this;
return (new ttt.core.t36151(self__.owner,self__.data,self__.game,meta36152__$1));
});

ttt.core.t36151.cljs$lang$type = true;

ttt.core.t36151.cljs$lang$ctorStr = "ttt.core/t36151";

ttt.core.t36151.cljs$lang$ctorPrWriter = (function (this__16732__auto__,writer__16733__auto__,opt__16734__auto__){
return cljs.core._write.call(null,writer__16733__auto__,"ttt.core/t36151");
});

ttt.core.__GT_t36151 = (function __GT_t36151(owner__$1,data__$1,game__$1,meta36152){
return (new ttt.core.t36151(owner__$1,data__$1,game__$1,meta36152));
});

}

return (new ttt.core.t36151(owner,data,game,cljs.core.PersistentArrayMap.EMPTY));
});
...
//# sourceMappingURL=core.js.map?rel=1428606261885