...
return cljs.core.reduce.call(null,(function (result,p__35765){
var vec__35766 = p__35765;
var k = cljs.core.nth.call(null,vec__35766,(0),null);
var v = cljs.core.nth.call(null,vec__35766,(1),null);
...
var vec__35768 = clojure.data.diff.call(null,va,vb);
var a_STAR_ = cljs.core.nth.call(null,vec__35768,(0),null);
var b_STAR_ = cljs.core.nth.call(null,vec__35768,(1),null);
var ab = cljs.core.nth.call(null,vec__35768,(2),null);
...
clojure.data.EqualityPartition = (function (){var obj35770 = {};
return obj35770;
})();
...
return (function (){var or__16145__auto__ = (clojure.data.equality_partition[goog.typeOf(x__16789__auto__)]);
if(or__16145__auto__){
return or__16145__auto__;
} else {
var or__16145__auto____$1 = (clojure.data.equality_partition["_"]);
...
clojure.data.Diff = (function (){var obj35772 = {};
return obj35772;
})();

clojure.data.diff_similar = (function diff_similar(a,b){
if((function (){var and__16133__auto__ = a;
if(and__16133__auto__){
...
var x__16789__auto__ = (((a == null))?null:a);
return (function (){var or__16145__auto__ = (clojure.data.diff_similar[goog.typeOf(x__16789__auto__)]);
if(or__16145__auto__){
return or__16145__auto__;
} else {
var or__16145__auto____$1 = (clojure.data.diff_similar["_"]);
if(or__16145__auto____$1){
return or__16145__auto____$1;
} else {
...
if((function (){var G__35773 = x;
if(G__35773){
var bit__16826__auto__ = (G__35773.cljs$lang$protocol_mask$partition0$ & (1024));
if((bit__16826__auto__) || (G__35773.cljs$core$IMap$)){
return true;
} else {
if((!G__35773.cljs$lang$protocol_mask$partition0$)){
return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IMap,G__35773);
} else {
return false;
}
}
...
if((function (){var G__35774 = x;
if(G__35774){
var bit__16826__auto__ = (G__35774.cljs$lang$protocol_mask$partition0$ & (4096));
if((bit__16826__auto__) || (G__35774.cljs$core$ISet$)){
return true;
} else {
if((!G__35774.cljs$lang$protocol_mask$partition0$)){
return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.ISet,G__35774);
} else {
return false;
}
}
...
if((function (){var G__35775 = x;
if(G__35775){
var bit__16826__auto__ = (G__35775.cljs$lang$protocol_mask$partition0$ & (16777216));
if((bit__16826__auto__) || (G__35775.cljs$core$ISequential$)){
return true;
} else {
if((!G__35775.cljs$lang$protocol_mask$partition0$)){
return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.ISequential,G__35775);
} else {
return false;
}
}
...
return (function (){var G__35776 = (((clojure.data.equality_partition.call(null,a) instanceof cljs.core.Keyword))?clojure.data.equality_partition.call(null,a).fqn:null);
switch (G__35776) {
case "map":
...
//# sourceMappingURL=data.js.map?rel=1428568921146